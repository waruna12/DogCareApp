...
class AddOtherMedicalPage extends StatefulWidget {
  final String tag;

  const AddOtherMedicalPage({Key key, this.tag = " no value"})
      : super(key: key);

  @override
  _AddOtherMedicalPageState createState() => _AddOtherMedicalPageState();
}

class _AddOtherMedicalPageState extends State<AddOtherMedicalPage> {
  String _name;

  var _currentVaccinesSelected = 'Fever';
            ...
            child: Column(
              ...
              children: <Widget>[
                customDropdownFormField(
                    ...
                    placeholder: "Type Of illnes :",
                    listItems: ['Fever', 'aaa', 'bbb'],
